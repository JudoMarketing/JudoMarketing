...
// El captcha de Supabase Auth (Attack Protection) está encendido y exige un
// token en CADA llamada de auth, incluida la entrada de Administración. Este
// widget es quien lo genera: sin él, ningún login pasa. Si el widget no carga
// (bloqueador de anuncios, red rara), el botón se habilita igual y decide el
// servidor (ver `bloqueaEnvio`).
