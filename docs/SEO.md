...
4. **Enlaces (backlinks)**: directorios gratuitos (Yelp, Bing Places,
   ...
   |---|---|
   | zanoah.shop | ✅ Enlace a Judo + a Delivery Rush, y `creator` en el schema (el trabajo quedó en la rama `archivo/footer-dos-sitios`; falta traerlo a `master` y desplegar) |
